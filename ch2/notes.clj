...
(def install-polynomial-package
  ;;internal procedures
  ;;representation of pol
  (defn make-poly [variable term-list]
    (cons variable term-list))
  (defn variable [p] (first p))
  (defn term-list [p] (rest p))
  (defn same-variable? [p1 p2] (= (variable p1) (variable p2)))
  (defn variable? [p] ...)

  ;;representation of terms and term lists
  (defn adjoin-term [x p] ...)
  (defn coeff [])
  (defn add-poly [p1 p2] ...)
  (defn mul-poly [p1 p2] ...)
